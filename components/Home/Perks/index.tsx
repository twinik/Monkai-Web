			...
			<div className="perks-grid">
				<div className="perk">
					...
					<p className="perk-text">
						...
						create a new unique monkai nft. This will allow holders
						to have nfts that are special to them!
					</p>
				</div>
				<div className="perk">
					...
					<p className="perk-text">
						...
						nfts. This will ensure that our holders can pride
						themselves in owning their nfts and enjoy it as its own
						piece of art.
					</p>
				</div>
				<div className="perk">
				...
				<div className="perk">
					...
					<p className="perk-text">
						...
						they will receive a free nft from the third mint. I bet
						you'll be excited for that one!
					</p>
				</div>
				<div className="perk">
					...
					<p className="perk-text">
						...
						passive income from the Monkai token.
					</p>
				</div>
				<div className="perk">
					<Image
