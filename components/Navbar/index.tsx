...
export const Navbar: React.FC<Props> = ({ navbar, setNavbar }) => {
	...
	return (
		<div>
			<div className="w-full top-0 lg:px-8 px-5 lg:pt-8 z-70  fixed top-0 lg:relative navbar">
				<div className="flex h-full border-b border-white items-center justify-center max-w-11xl mx-auto border-opacity-0">
					...
					>
						<div className="hamburger-lines">
							<span
								className={`line line1 ${navbar && "checked"}`}
							></span>
							<span
								className={`line line2 ${navbar && "checked"}`}
							></span>
							<span
								className={`line line3 ${navbar && "checked"}`}
							></span>
						</div>
					</div>
					<div
